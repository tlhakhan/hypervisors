...
LIBVIRT_GUESTS_ON_SHUTDOWN="shutdown"
LIBVIRT_GUESTS_SHUTDOWN_TIMEOUT=120
LIBVIRT_GUESTS_PARALLEL_SHUTDOWN=15
LIBVIRT_GUESTS_ON_BOOT="start"
LIBVIRT_GUESTS_START_DELAY=5
